...
class PreferencesRepositoryImpl @Inject constructor(
    ...
    override suspend fun updateHapticFeedback(enabled: Boolean) = preferencesManager.updateHapticFeedback(enabled)
    override suspend fun updateKeepScreenOn(enabled: Boolean) = preferencesManager.updateKeepScreenOn(enabled)
    override suspend fun updateMemorySettings(settings: MemorySettings) = preferencesManager.updateMemorySettings(settings)
    override suspend fun updatePrivacySettings(settings: PrivacySettings) = preferencesManager.updatePrivacySettings(settings)
    override suspend fun updateNotificationSettings(settings: NotificationSettings) = preferencesManager.updateNotificationSettings(settings)
